  ...
  return (
    <Wrapper>
      ...
      <ContentBox>
        ...
        <Paragraph><strong>a</strong> is the numerator (the number of parts you have)</Paragraph>
        <Paragraph><strong>b</strong> is the denominator (the total number of parts)</Paragraph>
        ...
        <Paragraph>Here are more examples:</Paragraph>
        <ExampleList>
        ...
        <SectionTitle>Different Types of Fractions:</SectionTitle>
        <ExampleList>
        ...
        <FunTip>
          Fun Tip 💡: Fractions can be converted into decimals and percentages. For example, 1/2 is equivalent to 0.5 or 50%!
        </FunTip>
      </ContentBox>
    </Wrapper>
  );
